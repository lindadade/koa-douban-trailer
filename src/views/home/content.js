...
const site = 'http://q3tvd6cyf.bkt.clouddn.com'
            ...
            movies.map((it, i) => (
              ...
              >
                <Card
                  ...
                  cover={<img onClick={() => this._showModal(it)} src={ it.poster } style={{ width: '280px', height: '400px' }} />} //site + it.posterKey + '?imageMogr2/thumbnail/x1680/crop/1080x1600'
                >
                  <Meta
